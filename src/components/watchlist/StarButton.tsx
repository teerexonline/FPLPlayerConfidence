 ...
 *
 * Empty star (not watchlisted) → accent-filled star on click.
 * Springs into place on toggle; never bounces or overshoots.
 * Must be inside a WatchlistProvider.
 */
export function StarButton({
  ...
  return (
    <motion.button
      type="button"
      aria-label={
        isWatchlisted ? `Remove ${playerName} from watchlist` : `Add ${playerName} to watchlist`
      }
